...
class SM_Setting {
    ...
    public function __construct() {
       ...
       // add_action('plugins_loaded', function() {
            if (!defined('SM_URL')) {
                define('SM_URL', 'https://slushmoney.net/app/');
       ...
       // });
        ...
        add_action("admin_menu", function () {
            add_menu_page(
                    "Slushmoney Settings", "Slushmoney", "manage_options", "slush_money", array($this, 'smGeneralSettingsContents'), plugins_url('images/logo.png', __FILE__), 6);
